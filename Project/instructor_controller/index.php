...
switch($action){
    ...
    case 'add_instructor':
        ...
        if($fname === NULL || $lname === NULL || $gender === NULL ||
                ...
                || $password != $confirm_p){
            $error = "Invalid instructor data. Check all fields and try again.";
            include('../view/registration_error.php');
        } else {
            add_instructor($fname, $lname, $gender, $email, $password);
    ...
    case 'login_instructor':
        ...
        if($email === NULL || $password === NULL) {
            ...
            $isLoggedIn = instructor_login($email, $password);
            if($isLoggedIn) {
